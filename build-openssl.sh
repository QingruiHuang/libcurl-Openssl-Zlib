...
{
LIB_SRC=lib/$1
echo "create_lib -1- LIB_SRC = ${LIB_SRC}"
LIB_DST=${OPENSSL_UNIVERSAL_LIB_DIR}/$1
echo "create_lib -2- LIB_DST = ${LIB_DST}"
LIB_PATHS=( ${ARCH_LIST[@]/#/${OPENSSL_BUILD_DIR}/} )
LIB_PATHS=( ${LIB_PATHS[@]/%//${LIB_SRC}} )
echo "create_lib -3- LIB_PATHS = ${LIB_DST}"
lipo ${LIB_PATHS[@]} -create -output ${LIB_DST}
echo "create_lib -4- lipo = ${LIB_PATHS[@]} -create -output ${LIB_DST}"
}
echo "create_lib \"libssl.a\""
create_lib "libssl.a"
echo "create_lib \"libcrypto.a\""
